...
class OnAirToday extends Component {
...
const mapStateToProps = (state) => {
  return {
    data: state.tv.onTheAirTodayTV
  };
};

const mapDispatchToProps = dispatch => {
  return {
    getOnTheAirToday: () => dispatch(tvAction.getOnTheAirTodayTV())
  };
};


export default connect(mapStateToProps, mapDispatchToProps)(OnAirToday);
