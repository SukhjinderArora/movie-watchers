...
class OnAirTV extends Component {
...
const mapStateToProps = (state) => {
  return {
    data: state.tv.onTheAirTV
  };
};

const mapDispatchToProps = dispatch => {
  return {
    getOnTheAirTV: () => dispatch(tvAction.getOnTheAirTV())
  };
};


export default connect(mapStateToProps, mapDispatchToProps)(OnAirTV);
